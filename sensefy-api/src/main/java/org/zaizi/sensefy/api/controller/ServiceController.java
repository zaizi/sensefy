 ...
 *
 **/
package org.zaizi.sensefy.api.controller;
...
import org.zaizi.RequestURI;
import org.zaizi.sensefy.api.dto.response.search.AutoCompleteResponse;
import org.zaizi.sensefy.api.dto.response.search.SearchResponse;
import org.zaizi.sensefy.api.service.SearchService;
import org.zaizi.sensefy.api.service.SemanticSearchService;
import org.zaizi.sensefy.api.service.SolrSmartAutoCompleteService;
...
public class ServiceController extends WebMvcAutoConfigurationAdapter {
	...
	public SearchResponse entityDrivenSearch(@RequestParam(required=false) String entityId, @RequestParam(required=false) String entityType,
