		...
		try
		{
			...
			if(results1.equals(final1))
			{
        		...
        		if(default_feature1_result.equals("10"))
        		{
            		...
            		String default_feature2 = "//div[@id='se-results']/div[1]/div/div/div[1]/span[text()='Showing results 1-10 of 114']";
            		...
            		String expected_result2 = "Showing results 1-10 of 114";
			...
			if(results2.equals(final2))
			{
        		...
        		if(default_feature3_result.equals("10"))
        		{
            		...
            		String default_feature4 = "//div[@id='se-results']/div[1]/div/div/div[1]/span[text()='Showing results 10-20 of 114']";
            		...
            		String expected_result4 = "Showing results 10-20 of 114";
