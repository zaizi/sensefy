 ...
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html"> <carousel>
 *          <slide> <img src="http://placekitten.com/150/150"
 *          style="margin:auto;"> <div class="carousel-caption">
 *          <p>
 *          Beautiful!
 *          </p>
 *          </div> </slide> <slide> <img src="http://placekitten.com/100/150"
 *          style="margin:auto;"> <div class="carousel-caption">
 *          <p>
 *          D'aww!
 *          </p>
 ...
 *          ng-controller="CarouselDemoCtrl"> <carousel> <slide ng-repeat="slide
 *          in slides" active="slide.active" index="$index"> <img
 ...
 *          {{slide.text}}
 *          </p>
 *          </div> </slide> </carousel> Interval, in milliseconds: <input
 *          type="number" ng-model="myInterval"> <br />
  ...
  return {
    ...
    link: function(scope, element, attrs, ctrl) {
      ...
      function getDates(startDate, n) {
        ...
        current.setHours(12); // Prevent repeated dates because of timezone
								// bug
        while ( i < n ) {
        ...
        compile: function (tElem, tAttrs) {
          ...
          return function link ( scope, element, attrs, tooltipCtrl ) {
            ...
            function show() {
              ...
              // If there is a pending remove transition, we must cancel it,
				// lest the
            ...
            function hide() {
              ...
              // if tooltip is going to be shown after delay, we must cancel
				// this
 ...
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html"> <tabset>
 *          <tab heading="Tab 1"><b>First</b> Content!</tab> <tab
 *          heading="Tab 2"><i>Second</i> Content!</tab> </tabset>
 *          <hr />
 *          <tabset vertical="true"> <tab heading="Vertical Tab 1"><b>First</b>
 *          Vertical Content!</tab> <tab heading="Vertical Tab 2"><i>Second</i>
 *          Vertical Content!</tab> </tabset> <tabset justified="true"> <tab
 *          heading="Justified Tab 1"><b>First</b> Justified Content!</tab>
 ...
 *          select="alertMe()"> <tab-heading><i class="icon-bell"></i> Alert
 *          me!</tab-heading> Second Tab, with alert callback and html heading!
 *          </tab> <tab ng-repeat="item in items" heading="{{item.title}}"
 *          disabled="item.disabled" active="item.active"> {{item.content}}
 *          </tab> </tabset> </div> </file> <file name="script.js"> function
 *          TabsDemoCtrl($scope) { $scope.items = [ { title:"Dynamic Title 1",
 *          content:"Dynamic Item 0" }, { title:"Dynamic Title 2",
 *          content:"Dynamic Item 1", disabled: true } ];
 * 
 ...
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html"> <tabset>
 *          <tab> <tab-heading><b>HTML</b> in my titles?!</tab-heading> And
 *          some content, too! </tab> <tab> <tab-heading><i class="icon-heart"></i>
 *          Icon heading?!?</tab-heading> That's right. </tab> </tabset>
 *          </file> </example>
 */
  ...
  return {
    ...
    compile: function(elm, attrs, transclude) {
      return function postLink(scope, elm, attrs, tabsetCtrl) {
        ...
        // This code is duplicated from the lines above to make it easy to
		// remove once
...
.controller('TimepickerController', ['$scope', '$attrs', '$parse', '$log', '$locale', 'timepickerConfig', function($scope, $attrs, $parse, $log, $locale, timepickerConfig) {
  ...
  function updateTemplate( keyboardChange ) {
    ...
    if ( $scope.showMeridian ) {
      hours = ( hours === 0 || hours === 12 ) ? 12 : hours % 12; // Convert
																	// 24 to 12
																	// hour
																	// system
    }
