    ...
    angular.module('SensefyConfiguration', ['ngSanitize', 'ngRoute', 'pascalprecht.translate'])
        ...
        .constant('SensefyTranslations', {
            'en-us': {
                ...
                'data.modifiedsim': 'modified',
                'data.createdsim': 'created',
                'preview.page': 'Page',
                'preview.of': 'of',
            ...
            'es-es': {
                ...
                'txtDocumentsFound': 'Mostrando resultados {{docStart}}-{{docStart+docPerPage}} of {{documents}}.',
