...
module.exports = function(grunt) {
        ...
        .initConfig({
            ...
            connect : {
                ...
                livereload : {
                    options : {
                        open : true,
                        base : [ 'app/assets', '<%= yeoman.app %>', '<%= yeoman.app %>/../' ],
                        middleware: function (connect, options) {
                            var middlewares = [];

                            middlewares.push(modRewrite([
                                '!/api|/assets|\\.png|\\.jpg|\\.gif|\\.html|\\.js|\\.css|\\woff|\\ttf|\\swf$ /index.html'
                            ]));
            ...
            removelogging: {
                dist: {
                    src: "<%= yeoman.dist %>'/scripts/main.min.js" // Each file will be overwritten with the output!
                }
            },
            ...
            concurrent : {
                ...
                dist : [ 'copy:javascripts', 'copy:styles', 'imagemin', 'svgmin' ]
            },
    ...
    grunt.registerTask('server', function(target) {
        grunt.log.warn('The `server` task has been deprecated. Use `grunt serve` to start a server.'['yellow'].bold);
